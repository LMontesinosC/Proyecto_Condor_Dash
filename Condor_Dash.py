...
font_titulo = pygame.font.Font('Fonts\Titulo\ka1.ttf', 75)                                              ### Cambiar Direccion
font_boton = pygame.font.Font('Fonts\Texto\Righteous-Regular.ttf', 35)                                  ### Cambiar Direccion
font_texto = pygame.font.Font('Fonts\Texto\Righteous-Regular.ttf', 20)                                  ### Cambiar Direccion
font_texto_pequeño = pygame.font.Font('Fonts\Texto\Righteous-Regular.ttf', 15)                          ### Cambiar Direccion

# Extras
posiciones_ocupadas = set()     # Conjunto global para evitar superposiciones

### Cargar imágenes
condor_img = pygame.image.load('w_condor_v1.png')  # Carga de imagen                                    ### Cambiar Direccion
condor_img = pygame.transform.scale(condor_img, (60, 20))  # Escalado de imagen

menu_img = pygame.image.load('menu.png')                                                                ### Cambiar Direccion

valle_img = pygame.image.load('w_valle_v1.png')                                                         ### Cambiar Direccion
valle_img = pygame.transform.scale(valle_img, (2400, 600))

ciudad_img = pygame.image.load('w_ciudad_v1.png')                                                       ### Cambiar Direccion
ciudad_img = pygame.transform.scale(ciudad_img, (2400, 600))

industria_img = pygame.image.load('w_industria_v1.png')                                                 ### Cambiar Direccion
industria_img = pygame.transform.scale(industria_img, (2400, 600))

mina_img = pygame.image.load('w_mina_v1.png')                                                           ### Cambiar Direccion
mina_img = pygame.transform.scale(mina_img, (2400, 600))

paloma_img = pygame.image.load('w_paloma_v1.png')                                                       ### Cambiar Direccion
paloma_img = pygame.transform.scale(paloma_img, (65, 20))  

cfc_img = pygame.image.load('w_cfc_v1.png')                                                             ### Cambiar Direccion
cfc_img = pygame.transform.scale(cfc_img, (150, 70))

texturas = {
    "recto": pygame.image.load("w_recto.png"),                                                          ### Cambiar Direccion
    "esquina": pygame.image.load("w_esquina.png"),                                                      ### Cambiar Direccion
    "bifurcacion": pygame.image.load("w_bifurcacion.png"),                                              ### Cambiar Direccion
    "cruce": pygame.image.load("w_cruce.png"),                                                          ### Cambiar Direccion
    "extremo": pygame.image.load("w_extremo.png")                                                       ### Cambiar Direccion
}
...
class Cliente_local:
    ...
    def conectar_a_servidor(self, ip, puerto):
...
class Transicion(Escenario):
    def __init__(self, posicionX, velocidad, condor, modo, cantidad, tiempo_espera):
        ...
        self.imagen_original = pygame.image.load('w_transicion.png')                                        ### Cambiar Direccion
        self.rectangulos = []
                ...
                if event.type == pygame.MOUSEBUTTONDOWN:
                    ...
                    if estado_boton_unirse_manual:
                        if boton_unirse_manual.collidepoint(event.pos):
                            self.cliente.conectar_a_servidor(self.UP_IP, PUERTO_TCP)
                    ...
                    if estado_boton_unirse_automatico:
                        ...
                        for i in range(len(botones_unirse)):
                            if botones_unirse[i].collidepoint(event.pos):
                                ...
                                self.cliente.conectar_a_servidor(ip, PUERTO_TCP)
                                print(f"Boton presionado: {i + 1}")
                                self.cliente.menu_espera_partida_local(self.datos_servidores_automaticos[i], self.CP_username, self.CP_partyname, self.UP_username)
...
class Puntuacion:
    def __init__(self, velocidad):
        ...
        self.velocidad = velocidad
        self.puntuacion = 0
        with open('CD_P.txt', 'r') as leer_puntaje:                                                 ### Cambiar Direccion
    ...
    def ciclo(self):
        ...
        if self.puntuacion > self.puntaje_maximo:
            ...
            with open('CD_P.txt', 'w') as escribir_puntaje:                                         ### Cambiar Direccion
